...
<div class="mui-card" style="margin-bottom: 35px;">
      ...
      <!-- 目录 -->
<Catalog :id="id" v-show="show" :booktitle='booktitle' @readshow='readshows'></Catalog>
  </div>
</template>
<script>
...
import { bookcontent, bookcatalog,bookhy } from "../../network/request.js";
...
export default {
  ...
  computed: {
    ...mapState(["bookselldata", "bookdata","usercolor","userfont"]),
